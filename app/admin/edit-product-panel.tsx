...
export default function EditProductPanel({ initialSlug = null }: EditProductPanelProps) {
  ...
  // Save Desc (with optional preview)
  ...
  return (
    <section style={sectionStyle} aria-label="Product editor">
      {/* Top: two-column grid (Main | Preview) */}
      ...
      <section style={{ ...(cardStyle as any), gap: '1.25rem', width: '100%', marginTop: '1.25rem' }}>
        ...
        <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
          <button onClick={() => handleSaveDescription(false)} style={buttonStyle as any}>Guardar</button>
          <button onClick={() => handleSaveDescription(true)} style={disabledButtonStyle as any}>Guardar y Ver</button>
        </div>
      </section>
    </section>
  );
